...
<p>Karl Marx (1818–1883) was shaped by the turbulent socio-economic conditions of 19th-century industrial Europe — mass poverty, brutal working conditions, and glaring inequality between factory owners and labourers. His famous dictum: <strong>"Philosophers have so far only interpreted the world; the point is to change it."</strong></p>
...
<blockquote>"It is not the consciousness of men that determines their existence. It is their social existence that determines their consciousness."</blockquote>

<h2>Historical Materialism</h2>

<p><strong>Book:</strong> <em>German Ideology</em> (1845–46); <em>Contribution to the Critique of Political Economy</em> (1859).</p>

<p>Historical Materialism (HM) is Marx's general theory of society and history. It is:</p>
<ul>
  <li><strong>Historical</strong> — it analyses the evolution of society across time.</li>
  <li><strong>Materialistic</strong> — it prioritises material (economic) factors over ideas or consciousness.</li>
</ul>

<h3>Basic Assumptions</h3>
<ul>
  <li>The primary need of human beings is <strong>survival</strong> — food, clothing, shelter. These are not available ready-made; nature provides only raw materials.</li>
  <li>To survive, humans must <strong>produce</strong>. Production is therefore "the first historical act."</li>
  <li>To produce, humans must enter into <strong>social relations of production</strong> — they cannot produce alone.</li>
  <li>One institution — the <strong>economy</strong> — dominates all others and defines the character of the entire society.</li>
</ul>
...
<h3>Forces of Production (FoP)</h3>
<ul>
  <li>The material aspect of production — tools, techniques, machinery, raw material, and the labour power of workers.</li>
  <li>Represent man's control over nature. As history progresses, this control increases.</li>
  <li>Range from stone tools in primitive society to complex factory machinery in industrial capitalism.</li>
</ul>

<h3>Relations of Production (RoP)</h3>
<ul>
  <li>The social relations that people enter into to produce — essentially, <strong>who owns what</strong>.</li>
  <li>Two types: (a) relations between humans and things (ownership/non-ownership), (b) relations between human and human (domination/subordination).</li>
  <li>In every society since the rise of private property, two broad classes emerge: <strong>haves</strong> (owners/dominators) and <strong>have-nots</strong> (non-owners/subordinates).</li>
</ul>

<h3>Mode of Production (MoP)</h3>
<p>The <strong>Mode of Production</strong> = FoP + RoP together. It refers to the total way a society organises itself to produce goods. Every historical period is characterised by a specific MoP that generates specific class conflicts.</p>

<h2>Stages of Historical Evolution</h2>
<p>Marx identified four historical MoPs and projected two future stages:</p>

<table>
  <tr>
    <th>Stage</th>
    <th>Means of Production</th>
    <th>Relations of Production</th>
    <th>Contradiction</th>
  </tr>
  <tr>
    <td><strong>Primitive Communism</strong></td>
    <td>Land, basic tools, forests; communal ownership</td>
    <td>Cooperation & mutual help; no class, no private property</td>
    <td>Population growth → scarcity → specialised tools → private property emerges</td>
  </tr>
  <tr>
    <td><strong>Ancient (Slave) Mode</strong></td>
    <td>Humans (slaves), large-scale agriculture, mines</td>
    <td>Master owns slave as property; absolute domination</td>
    <td>Slaves want freedom; masters want profit → slave revolts (Spartacus, Haitian Revolution)</td>
  </tr>
  <tr>
    <td><strong>Feudal Mode</strong></td>
    <td>Land, ploughs, animals; lords own land</td>
    <td>Lords & serfs bound by tradition and mutual obligations; serfs tied to land</td>
    <td>Lords demand more; serfs can't meet subsistence → revolts + industrial revolution → capitalism</td>
  </tr>
  <tr>
    <td><strong>Capitalist Mode</strong></td>
    <td>Factories, machinery, capital, wage-labour</td>
    <td>Bourgeoisie owns MoP; proletariat free to sell labour (but has no alternative)</td>
    <td>Overproduction, falling rate of profit, alienation, class polarisation → proletarian revolution</td>
  </tr>
  <tr>
    <td><strong>Socialism</strong> (future)</td>
    <td>Socially owned means of production</td>
    <td>Dictatorship of the proletariat; equality; cooperatives</td>
    <td>Transitional phase; bourgeoisie may resist</td>
  </tr>
  <tr>
    <td><strong>Communism</strong> (end of history)</td>
    <td>Communal ownership; no private property</td>
    <td>Classless, stateless society; each contributes by ability, receives by need</td>
    <td>No contradiction → no further change</td>
  </tr>
</table>

<h2>Dialectical Materialism</h2>

<p>Engels systematised Marx's method into three laws of dialectics — applicable to nature, history, and society:</p>

<h3>1. Law of Unity and Conflict of Opposites</h3>
<p>Everything contains internal contradictions (opposites) that presuppose each other yet are in conflict. In society, this takes the form of <strong>class struggle</strong>. The owner cannot exist without the worker; the worker cannot survive without wages. But their interests are fundamentally opposed. This conflict is the engine of history.</p>

<h3>2. Law of Transformation of Quantity into Quality</h3>
<p>Change is not smooth and linear. Quantitative changes accumulate gradually — growing exploitation, rising alienation, economic crises — until a tipping point is reached and a sudden <strong>qualitative change</strong> (revolution) occurs. Like water turning to steam: gradual heat → sudden phase change.</p>

<h3>3. Law of Negation of Negation</h3>
<p>Each MoP contains contradictions that eventually bring about its downfall. The new system negates the old, but retains the best of it. Feudalism negated slavery; capitalism negated feudalism; socialism will negate capitalism. As Raymond Aron put it: <em>"Capitalism is the negation of feudal society, and socialism would be the negation of capitalism — negation of negation."</em></p>

<h4>Dialectical Idealism (Hegel) vs Dialectical Materialism (Marx)</h4>
<table>
  <tr>
    <th>Dialectical Idealism (Hegel)</th>
    <th>Dialectical Materialism (Marx)</th>
  </tr>
  <tr>
    <td>Consciousness determines being (ideas first)</td>
    <td>Being determines consciousness (matter first)</td>
  </tr>
  <tr>
    <td>History = conflict between ideas</td>
    <td>History = conflict between classes over resources</td>
  </tr>
  <tr>
    <td>State embodies supreme values</td>
    <td>State embodies interests of dominant class</td>
  </tr>
  <tr>
    <td>Metaphysical/spiritual process</td>
    <td>Material process grounded in economy</td>
  </tr>
</table>

<h2>Class and Class Struggle</h2>

<p><strong>"History of hitherto existing societies is the history of class struggle."</strong> — Communist Manifesto, 1848</p>

<h3>Definition of Class</h3>
<p>A class is a group of people sharing the <strong>same position in the process of production</strong>. In capitalism: bourgeoisie (earn profit) vs. proletariat (earn wages). These are objective positions — not defined by income or status but by <em>relationship to the means of production</em>.</p>
...
<p>Marx acknowledged intermediate classes (petty bourgeoisie, lumpen proletariat). But through <strong>bourgeoisification</strong> and <strong>proletarianisation</strong>, these intermediate classes gradually get absorbed into the two poles. The proletariat keeps getting poorer through <strong>pauperisation</strong>.</p>

<h3>Mechanism of Class Struggle</h3>
<p>Class struggle intensifies as contradictions deepen. Revolution requires <strong>mature conditions</strong>:</p>
<ul>
  <li>A critical mass of workers</li>
  <li>Networks of communication among workers</li>
  <li>Emergence of a proper ideology (given by leadership)</li>
  <li>Identification of a common enemy</li>
  <li>Economic crisis that radicalises the have-nots</li>
</ul>
<p>Marx distinguished earlier revolts (slave/serf) as <em>false revolutions</em> driven by false consciousness — aided by an emerging class (bourgeoisie). The workers' revolution will be a <em>true revolution</em> because the proletariat has no alternative and no emerging class to help them — only true consciousness can drive it.</p>

<h2>Alienation</h2>

<blockquote>"What makes us distinctively human is our capacity for intelligent and creative work — ingenuity." — Marx</blockquote>

<p>Marx introduced alienation in <em>Economic and Philosophical Manuscripts</em> (1844). His starting point is <strong>species-being</strong> (Gattungswesen) — the idea that humans are fundamentally creative, labouring beings. Work, freely done, expresses human essence. Capitalism subverts this.</p>

<p><strong>Alienation</strong> = the breakdown of the natural interconnection between people, and between people and what they produce. In capitalist society, the creation of humanity appears to humans as <em>alien objects</em> — things beyond their control.</p>
...
<table>
  <tr>
    ...
    <th>Level of Alienation</th>
  </tr>
  <tr>
    <td>Primitive Communism</td>
    <td>Lowest — alienation caused only by nature (scarcity)</td>
  </tr>
  <tr>
    <td>Ancient (Slave)</td>
    <td>Moderate — slaves have some control over production</td>
  </tr>
  <tr>
    <td>Feudal</td>
    <td>Increasing — serfs gradually alienated as lord's demands grow</td>
  </tr>
  <tr>
    <td>Capitalist</td>
    <td>Peak — "Subject-object relationships get inverted; objects become subject matters"</td>
  </tr>
  <tr>
    <td>Communist</td>
    <td>Zero — de-alienation achieved; Total Man realised</td>
  </tr>
</table>

<h3>Solution: De-Alienation and the Total Man</h3>
<p>Marx did not merely diagnose alienation — he prescribed its cure. De-alienation requires not just improved wages or working hours, but the <strong>transformation of the entire mode of production</strong>. Abolition of private property alone is insufficient; the whole productive process must change.</p>
<p>In communism, the <strong>Total Man</strong> is realised:</p>
<blockquote>"It is possible for me to do one thing today and another tomorrow — to hunt in the morning, fish in the afternoon, rear cattle in the evening and criticise after dinner."</blockquote>
<p>This represents complete freedom of the individual — self-realisation without the compulsion of a single, alienating role.</p>
...
<p>Marx was not blindly anti-capitalism. He acknowledged three positive contributions of the bourgeoisie:</p>
<ul>
  <li>Liberation of people from rural, feudal life.</li>
  <li>Questioning of monarchical state, traditional values, and norms — redefining success by market performance rather than moral grounds.</li>
  <li>Technological advances, urban growth, and industrial development.</li>
</ul>
...
`,
  'caste-system': `
<h2>Introduction — Caste as India's Most Distinctive Social Institution</h2>

<p>The caste system is the most complex, persistent, and sociologically significant form of social stratification found anywhere in the world. It combines ritual hierarchy with occupational specialisation, hereditary membership, endogamy, and a comprehensive ideology of purity and pollution into a single, interlocking system. While discrimination based on caste is constitutionally prohibited in India, caste continues to structure social relations, political mobilisation, marriage markets, and economic opportunity in both rural and urban India.</p>

<p>Unlike class (which is achieved and fluid) or race (which is phenotypically visible), caste is an ascribed, hereditary, and ritually sanctioned form of stratification unique to the Indian subcontinent — though Oliver Cox has compared it to race, and BR Ambedkar has argued it is more oppressive than either class or race.</p>

<h2>Features of the Caste System</h2>

<p>GS Ghurye identified six defining features of caste in his foundational text <em>Caste and Race in India</em> (1932), still widely used as the starting point for caste analysis:</p>

<h3>1. Segmental Division of Society</h3>
<p>Society is divided into a number of segments (castes) each of which is a well-developed social group. Membership is determined by birth and is hereditary. The individual belongs to the caste of their parents and cannot leave or change it. Each caste is a self-sufficient unit with its own norms, customs, traditions, and occupational specialisation. Social solidarity within the caste is strong; solidarity between castes is weak.</p>

<h3>2. Hierarchical Division</h3>
<p>Castes are not merely different — they are ranked in a hierarchical order from highest to lowest. The Brahmin traditionally occupies the apex of the ritual hierarchy; the "untouchable" castes are at the bottom, outside the four-varna scheme. This hierarchy is based primarily on the principle of ritual purity and pollution, not on economic wealth or political power. Weber: caste is the most developed form of status group stratification.</p>

<h3>3. Restrictions on Feeding and Social Intercourse</h3>
<p>Each caste has elaborate rules about with whom its members may share food and water. There are restrictions on <em>pakka</em> (cooked in ghee) and <em>kaccha</em> (cooked in water) food. Generally, a higher caste can accept pakka food from a lower caste but not kaccha food. These restrictions regulate social interaction and physically demarcate caste boundaries.</p>

<h3>4. Civil and Religious Disabilities and Privileges of Different Sections</h3>
<p>Upper castes enjoy extensive privileges — exclusive access to temples, sacred texts, elite occupations, and higher education. Lower castes suffer severe disabilities — exclusion from temples, wells, schools, and public spaces. Untouchable castes historically were not allowed to walk on public roads used by upper castes, to draw water from upper-caste wells, or to enter temples. These disabilities were enforced not just by social custom but by physical violence.</p>

<h3>5. Lack of Unrestricted Choice of Occupation</h3>
<p>Each caste has traditionally been associated with a specific hereditary occupation. Brahmins were priests and scholars; Kshatriyas were warriors and rulers; Vaishyas were merchants and traders; Shudras performed service and agricultural labour; "untouchable" castes handled ritually polluting tasks (leather work, sweeping, carrying of the dead). The Jajmani system institutionalised this occupational link through hereditary service relationships between castes in a village.</p>

<h3>6. Endogamy</h3>
<p>Endogamy is the most distinctive and persistent feature of the caste system. Members must marry within their own caste (and subcaste/gotra). Marrying outside the caste (hypergamy) is tolerated in some contexts but hypogamy (a woman marrying a man of lower caste) is strictly prohibited. Endogamy maintains caste purity, controls property transmission, and preserves the distinctiveness of each caste as a social unit. Today endogamy remains the most prevalent feature of caste even as other restrictions have weakened.</p>

<h2>Varna and Jati — The Two Levels of Caste</h2>

<p>A crucial distinction must be made between <strong>Varna</strong> and <strong>Jati</strong>:</p>
...
<table>
  ...
  <tr>
    <td>Four-fold textual classification — Brahmin, Kshatriya, Vaishya, Shudra</td>
    <td>Thousands of actual hereditary groups found in practice</td>
  </tr>
  <tr>
    <td>Pan-Indian, universal, unchanging — based on sacred texts</td>
    <td>Local, regional, variable — a product of specific historical and ecological conditions</td>
  </tr>
  <tr>
    <td>Ritual hierarchy is fixed and permanent</td>
    <td>Hierarchy varies locally and changes over time through political and economic shifts</td>
  </tr>
  <tr>
    <td>Brahmin always at the top; Shudra always at the bottom</td>
    <td>Local ranking of jatis is contested — powerful jatis may claim higher Varna status than others acknowledge</td>
  </tr>
  <tr>
    <td>A theoretical and textual construct</td>
    <td>The actual lived reality of caste in villages and towns</td>
  </tr>
</table>

<p>MN Srinivas: "The Varna model of caste presents ritual hierarchy as a permanent and static feature of Indian society, but the Jati model of caste varies locally." Dipankar Gupta similarly notes that the caste system as it operates in practice does not match the neat textual Varna hierarchy — powerful jatis contest their ranking and may refuse to acknowledge the supremacy of those textually above them.</p>

<h2>Sociological Perspectives on Caste</h2>

<h3>A. GS Ghurye — Indological Perspective</h3>
<p>GS Ghurye (1893–1983) is considered the father of Indian sociology. His approach was <strong>Indological</strong> — he used ancient Sanskrit texts (Vedas, Dharmashastra, Arthashastra) as primary sources for understanding Indian social institutions. His book <em>Caste and Race in India</em> (1932) remains the most comprehensive sociological analysis of caste.</p>
...
<p>MN Srinivas (1916–1999) brought fieldwork-based social anthropology to the study of Indian society. His studies of the Coorgs (Karnataka) and later Rampura village (Mysore) established the village as the key unit for studying caste in practice.</p>

<h4>Dominant Caste</h4>
<p>Srinivas coined the concept of the <strong>dominant caste</strong> to capture the actual distribution of power in Indian villages — which did not always correspond to the Varna hierarchy. A caste is dominant when it is numerically strong, economically powerful (owns land), and has high ritual status. In practice, dominance often depends on landholding and numerical strength more than ritual position.</p>

<p>The dominant caste controls the local economy (through land), local politics (through vote banks), and social life (through control of temples, water sources, and marriage decisions). Examples: Vokkaligas in parts of Karnataka, Reddys and Kammas in Andhra Pradesh, Patidars in Gujarat, Jats in Punjab and Haryana, Marathas in Maharashtra.</p>

<p>Dominant caste concept shows: ritual hierarchy (Varna) and secular power do not always coincide. A numerically large, landowning Shudra caste can exercise more power over a small Brahmin community than the ritual hierarchy suggests.</p>

<h4>Sanskritisation</h4>
<p>Srinivas's most famous concept — <strong>Sanskritisation</strong> — refers to the process by which a low or middle Hindu caste, or tribal or other group, changes its customs, ritual, ideology, and way of life in the direction of a high, and frequently twice-born caste.</p>

<p>The process typically involves: giving up meat-eating and alcohol; adopting vegetarianism (the Brahmin dietary code); wearing the sacred thread; adopting stricter purdah for women; performing Vedic rituals; claiming a higher Varna status in the Varna scheme. The reference group in Sanskritisation is a specific caste in the local area, not Brahmins in the abstract.</p>

<p>Sanskritisation as a form of social mobility: it enables positional change within the caste hierarchy but does not change the structure of the hierarchy itself. The low caste rises; the hierarchy remains intact. Srinivas called this "mobility within the system" rather than "mobility of the system."</p>

<p>Limitations of Sanskritisation:</p>
<ul>
  <li>It is a group phenomenon, not individual — an entire jati Sanskritises together. Individual mobility is not possible.</li>
  <li>Positional change only — the hierarchy is not challenged or transformed.</li>
  <li>Cannot account for the upward mobility of castes that have rejected Brahminic culture — Dalit Buddhist movements, self-respect movements.</li>
  <li>It reinforces Brahminic values as the standard of prestige — thereby perpetuating the ideological dominance of upper castes.</li>
  <li>According to Dumont, Sanskritisation is absent in the true caste system because mobility is not supposed to occur.</li>
  <li>M.N. Srinivas himself acknowledged: Sanskritisation can be seen as the "internalisation of Brahmanism by the lower castes," reinforcing rather than challenging the system.</li>
</ul>

<h4>Westernisation</h4>
<p>Srinivas also developed the concept of Westernisation — the changes brought about in Indian society and culture through more than 150 years of British rule. Unlike Sanskritisation (which involves moving up within the traditional hierarchy), Westernisation involves adopting Western cultural values: secular thought, humanitarianism, rationalism, individualism, democracy. It has produced a new elite that challenges the traditional caste hierarchy from outside the system. Westernisation and Sanskritisation both produce social change but in different directions.</p>

<h3>C. Louis Dumont — Homo Hierarchicus</h3>
<p>Louis Dumont's <em>Homo Hierarchicus: The Caste System and its Implications</em> (1966) is the most ambitious and controversial structural analysis of caste. Dumont approached caste as an anthropologist trained in the French structuralist tradition.</p>

<p>Dumont's central argument: the caste system is not merely a system of stratification but an ideology — a complete, coherent, and internally consistent worldview based on the opposition between <strong>purity and pollution</strong>. The pure is superior to the impure; this single principle organises the entire social hierarchy of Indian society.</p>
...
<p>Andre Beteille's study of the village of Sripuram in Tanjore district (published as <em>Caste, Class and Power</em>, 1965) is a landmark empirical study that challenged both Dumont's ideological approach and Srinivas's Dominant Caste framework.</p>

<p>Beteille's key findings:</p>
<ul>
...
<p>The Jajmani system was the economic dimension of the caste system at the village level. Each caste in a village had a hereditary service relationship with other castes: the Brahmin priest performed religious rituals; the carpenter made agricultural implements; the washerman cleaned clothes; the cobbler made and repaired shoes; the barber cut hair; the sweeper cleaned the village — all for the dominant farming caste (the <em>jajman</em>) in exchange for a fixed share of the harvest.</p>

<p>Perspectives on the Jajmani system:</p>
<ul>
  <li><strong>WH Wiser</strong> — the first to describe it systematically. Saw it as a form of mutual exchange — each caste served others and received payment in kind. Characterised it as "Hindu jajmani system."</li>
  <li><strong>Functionalist view</strong> — the Jajmani system created organic solidarity (as in Durkheim's sense) between interdependent castes; it provided economic security and social stability in traditional village India.</li>
  <li><strong>Henry Orenstein</strong> — the Jajmani system creates a form of organic solidarity between Jajman (upper caste) and Kamin (service caste) — but this solidarity blinds us to the exploitation of lower castes embedded in the relationship. The service castes are paid far less than the market value of their labour.</li>
  <li><strong>Marxist view</strong> — the Jajmani system is "feudalism in delivery of services by lower castes for the safety and livelihood of the dominant caste." It binds the lower castes to the village and to the dominant caste through debt, custom, and the absence of alternative economic opportunities.</li>
  <li><strong>Contemporary decline</strong> — the Jajmani system has largely broken down with commercialisation of agriculture, urbanisation, new occupational opportunities, and the advent of the market economy. When the link between caste and occupation breaks down, the Jajmani system withers away. Recognition of caste and occupation is the last to go.</li>
</ul>

<h2>Caste and Class — Relationship and Overlap</h2>
...
<table>
  ...
  <tr>
    <td>Ascribed — determined by birth</td>
    <td>Achieved — determined by education, income, occupation</td>
  </tr>
  <tr>
    <td>Closed — endogamy prevents mixing</td>
    <td>Open — individual mobility between classes is possible</td>
  </tr>
  <tr>
    <td>Based on ritual hierarchy — purity and pollution</td>
    <td>Based on economic resources — market position</td>
  </tr>
  <tr>
    <td>Common identity and solidarity within each caste</td>
    <td>Class consciousness varies — often weak</td>
  </tr>
  <tr>
    <td>Local — varies by region and village</td>
    <td>Universal — the same criteria apply everywhere</td>
  </tr>
</table>

<p>Beteille: in traditional Indian society, caste and class were cumulative (upper castes were also propertied classes). Post-independence, they have been dispersed — lower castes have gained political and economic power while upper castes have retained ritual status. Yet caste and class still significantly overlap: in India today, the poorest quintile of the population is disproportionately populated by Scheduled Castes and Scheduled Tribes.</p>

<p>Oliver Cox argued that caste is equivalent to "coloured" race in the American South — both are forms of social stratification based on descent, both enforced through violence and social exclusion, and both serve to maintain a cheap labour supply for the dominant group. Beteille and Gupta contested this, arguing caste is historically more complex and internally differentiated than race.</p>

<h2>Untouchability — Forms, Persistence, and Legal Framework</h2>

<h3>What is Untouchability?</h3>
<p>Untouchability refers to the practice of social exclusion, discrimination, and stigmatisation of the lowest castes (historically called "untouchables" or "achhuts") based on the belief that their very presence, touch, or shadow is polluting to members of higher castes. It is the most extreme and degrading expression of the caste system's purity-pollution ideology.</p>

<p>Untouchable castes were historically assigned the most ritually polluting tasks: removing human waste (manual scavenging), disposing of animal carcasses, working with leather, sweeping public spaces, washing clothes. Their labour was essential to village life; their persons were considered defiling.</p>

<h3>Forms of Untouchability</h3>
<ul>
  <li><strong>Physical untouchability</strong> — prohibition on touch; untouchables required to maintain physical distance from upper castes; prohibition on entering upper-caste homes.</li>
  <li><strong>Spatial untouchability</strong> — untouchable settlements (Dalit bastis) located outside the main village; separate streets and public spaces; geographic segregation in rural India persists today.</li>
  <li><strong>Temple entry prohibition</strong> — banned from entering caste Hindu temples. The Temple Entry Proclamation by the Travancore Maharaja (1936) and similar campaigns in Tamil Nadu were landmark moments. Dr Ambedkar led the Kalaram Temple Satyagraha (Nasik, 1930).</li>
  <li><strong>Restrictions on water sources</strong> — untouchables barred from using wells used by upper castes; Ambedkar led the Mahad Satyagraha (1927) demanding the right to use the public Chavdar Tank.</li>
  <li><strong>Educational exclusion</strong> — prohibited from attending same schools; forced to sit separately; denied access to the ears of the Brahmin teacher (Ekalavya myth). Jyotiba Phule established the first school for untouchable children in Pune (1848).</li>
  <li><strong>Occupational stigmatisation</strong> — forced into hereditary "unclean" occupations; manual scavenging (carrying human waste on the head) persists in India despite legal prohibition.</li>
  <li><strong>Social untouchability</strong> — prohibition on wearing shoes in the presence of upper castes; lower sitting posture; separate utensils in tea stalls; prohibition on upper-caste food.</li>
  <li><strong>Symbolic untouchability</strong> — untouchables required to tie a broom to their waist and a pot around their neck while walking in the street so that their footprints and shadow could not pollute the ground or the air.</li>
</ul>

<h3>Legal Framework Against Untouchability</h3>
<ul>
  <li><strong>Article 17 of the Constitution</strong> — "Untouchability is abolished and its practice in any form is forbidden." This is a fundamental right enforceable against both the state and private individuals.</li>
  <li><strong>The Untouchability (Offences) Act, 1955</strong> — later strengthened and renamed the <strong>Protection of Civil Rights Act, 1955</strong> — criminalised the practice of untouchability.</li>
  <li><strong>Scheduled Castes and Scheduled Tribes (Prevention of Atrocities) Act, 1989 (SC/ST Act)</strong> — provides for stricter punishment for atrocities against SC and ST members including violence, sexual assault, social boycott, and forced labour.</li>
  <li><strong>The Prohibition of Employment as Manual Scavengers and their Rehabilitation Act, 2013</strong> — prohibits manual scavenging and provides for rehabilitation of those engaged in it.</li>
</ul>

<h3>Persistence of Untouchability</h3>
<p>Despite legal prohibitions, untouchability persists in various forms:</p>
<ul>
  <li>Caste-based discrimination in education (separate seating, separate mid-day meal plates), employment, housing, and marriage.</li>
  <li>Violence against Dalits — atrocities including killing, rape, arson, and social boycott — continue to be reported. National Crime Records Bureau data shows consistent registration of crimes under the SC/ST Act.</li>
  <li>Manual scavenging — despite legal prohibition, hundreds of thousands of Dalits (mostly women) continue to be employed as manual scavengers in rural India and in cleaning sewer lines in cities.</li>
  <li>Caste-based discrimination in urban India — discrimination in housing (landlords refusing to rent to Dalits), in the workplace, and in social spaces.</li>
  <li>The "hidden apartheid" — untouchability in rural India is often invisible to urban observers and to the state. Field studies by Sukhadeo Thorat and others have documented persistent discrimination in village water sources, temples, barber shops, and tea stalls.</li>
</ul>

<h2>BR Ambedkar — Annihilation of Caste</h2>

<p>No thinker has engaged more radically, more systematically, and more personally with the question of caste than BR Ambedkar (1891–1956). Born into the Mahar (untouchable) caste of Maharashtra, Ambedkar experienced caste discrimination personally from childhood. He became the most educated Indian of his generation (PhD from Columbia, DSc from London) and devoted his intellectual and political life to the destruction of the caste system.</p>
...
<h3>Forces Challenging Caste</h3>
<ul>
  <li><strong>Urbanisation</strong> — urban anonymity weakens caste surveillance; diverse residential patterns; market-based relationships transcend caste.</li>
  <li><strong>Industrialisation</strong> — factory work and the labour market judge workers by productivity, not birth.</li>
  <li><strong>Education</strong> — exposure to universalistic values and diverse social networks.</li>
  <li><strong>Democracy</strong> — one person one vote gives numerical majority to lower castes; political mobilisation has produced Dalit and OBC political parties (BSP, RJD, SP) that have challenged upper-caste dominance.</li>
  <li><strong>Reservation policy</strong> — reservations in education, government employment, and legislatures for SCs (15%), STs (7.5%), and OBCs (27%) have opened new avenues of upward mobility and created a Dalit and OBC middle class.</li>
  <li><strong>Legal reform</strong> — constitutional prohibition of untouchability, SC/ST Atrocities Act, abolition of child labour, land reform legislation.</li>
  <li><strong>Mandal Commission</strong> — the V.P. Singh government's implementation of the Mandal Commission recommendations (1990) — extending reservation to OBCs in central government employment — was a landmark moment that reshaped Indian politics along caste lines.</li>
</ul>

<h3>Persistence of Caste</h3>
<ul>
  <li>Endogamy — inter-caste marriages remain rare even in urban areas; most Indians continue to marry within their caste. The matrimonial columns of Indian newspapers and matrimonial websites explicitly sort by caste.</li>
  <li>Caste-based politics — political parties mobilise caste identities; vote banks are organised on caste lines; caste census data (proposed) is a political battleground.</li>
  <li>Caste-based violence — honour killings for inter-caste marriages; attacks on Dalits who build pucca houses, ride horses, or fail to follow traditional codes of deference.</li>
  <li>Economic inequality — SC and ST households disproportionately represented among the poorest income quintiles; upper-caste households overrepresented among the wealthiest.</li>
  <li>New forms of caste discrimination — discrimination in urban housing, employment (studies have shown that identical CVs with upper-caste names receive more job interview calls than CVs with Dalit-caste names), and access to credit.</li>
</ul>

<h3>Caste and Democracy — A Complex Relationship</h3>
<p>Rajni Kothari (<em>Caste in Indian Politics</em>): in Indian democracy, caste and politics interact in a complex dialectical way. Caste has entered politics (caste groups use democratic politics to advance their collective interests) and politics has entered caste (the competition for votes has changed caste relations — castes that were traditionally deferential have become assertive). The result is what Kothari calls the "politicisation of caste" and the "casteisation of politics."</p>
...
<p>Lineage is the principle upon which inheritance is determined — whether property, name, and social membership pass through the father's line (patrilineage), the mother's line (matrilineage), or both. It refers to a kin group whose members trace descent from a common ancestor whose identity is known. A body of people arranged together on the basis of common blood linkage constitutes a lineage group. In a patriarchal society, daughters are typically not part of the father's lineage group — they are transferred to the husband's lineage at marriage.</p>

<p>Descent, by contrast, is the principle whereby a child is socially affiliated with the group of their parents. Where lineage defines the descent group as a structural unit, descent defines the relationship of affiliation that connects individuals to it. Classical anthropologists divide lineage systems into unilineal systems (where someone belongs either to the father's or mother's lineage — patrilineal or matrilineal) and non-unilineal systems (where multiple forms of relationships coexist, as in bilateral or ambilineal systems).</p>

<h3>Thinkers on Lineage and Descent in India</h3>

<p>Ghurye, taking an Indological perspective, emphasised the role of descent in defining marriage, family, and kinship in India. In northern India, one cannot marry within the extended kinship group — marriage is governed by rules of kinship and descent that prohibit unions for five to seven generations. Ghurye also identified <em>gotra</em> and <em>charna</em> as exogamous groups that bring dispersed people together. These kin categories of Indo-European cultures systematised the rank and status of people — derived from rishis (sages) who were the real or eponymous founders of each gotra. In this way, descent through mythic saintly figures became the basis of ritual hierarchy and social organisation across Brahminical communities.</p>

<p>Gail Omvedt takes this observation in a radical direction: caste, she argues, is an expanded descent system. The rules of caste endogamy and gotra exogamy together constitute a system of descent regulation that reproduces caste hierarchy across generations. Caste is not merely about ritual purity — it is a mechanism for controlling descent, inheritance, and alliance.</p>

<p>Andre Beteille observes that kinship in India is so strong that voting is driven by kinship rather than merit — the primary source of political recruitment is the kinship group. In this sense, the democratic political system in India is engaged in social and cultural reproduction rather than transcending it. Krishna Kumar makes the same point for economic life: kinship in India is so intensive that behind every corrupt man there is an ambitious family. Industrial recruitment takes place largely on the basis of kinship rather than merit. Both Beteille and Krishna Kumar agree on a striking finding — with modernity in India, kinship and descent have not changed significantly — making it critically important to study kinship under social transformation rather than assuming modernisation has dissolved it.</p>

<p>The role of descent and kinship in India is not limited to private spheres like marriage and family. It very well defines occupation (jati and occupational heredity), political activities (caste-based political mobilisation), industrial recruitment (nepotism), and access to resources (kinship networks in business). This is why the sociology of Indian kinship cannot be separated from the sociology of caste, class, and power.</p>

<h2>Types of Kinship Systems in India: Irawati Karve's Zones</h2>

<p>Irawati Karve, in her foundational work <em>Kinship Organisation in India</em>, mapped India's kinship diversity by identifying four distinct kinship zones — North, South, Central, and East — each with different rules of marriage, residence, descent, and the reckoning of kin relationships. These zones reflect the deep regional diversity of Indian society and demonstrate that there is no single "Indian kinship system" — the variation is structural and systematic.</p>

<h3>North Indian Kinship System</h3>

<p>The North Indian kinship zone covers areas of dominant Aryan cultural influence — the Hindi heartland, Rajasthan, Punjab, Haryana, Gujarat (in some respects), and also Odisha, Bihar, and West Bengal. The cardinal feature is the rigid separation of patrikins and matrikins. Within the patrilineal system, the father's brother is clearly distinguished from the father's sister's husband; older and younger father's brothers are distinguished from each other, with differential terms of address and respect attributed to each.</p>

<p>The rules of marriage are highly exhaustive and prohibitive. A man cannot receive a woman from any group to which he has offered a woman within the preceding five to seven generations. He cannot receive a woman from his mother's natal group, his mother's mother's group, his father's mother's group, or from his own village. This creates an elaborate system of inter-village exchange of brides — marriage is not an intra-family or intra-village matter but an inter-village one, extending kinship alliances over a wide geographic area.</p>

<p>The residential system is virilocal (patrilocal) — the married couple resides with or near the husband's parents. This involves a series of presentational obligations by the bride's family that continue throughout the marriage. Veena Das, analysing Punjabi kinship, observes that in North Indian kinship, the father-son relationship takes precedence over the husband-wife relationship. The natural sexual relationship between husband and wife is subdued to the socially established father-son relationship — glorifying patriarchy and keeping the conjugal bond secondary to the patrilineal descent group.</p>

<h3>South Indian Kinship System</h3>

<p>The South Indian kinship zone covers the entire south — Tamil Nadu, Karnataka, Andhra Pradesh, Kerala, and parts of Maharashtra and Odisha. The contrast with North India is sharp. There is no rigid distinction between patrilineal and matrilineal kins — instead, specific patrilineal kins are equated with specific matrilineal kins, creating a symmetrical kinship terminology.</p>

<p>The most striking feature is the preference for cross-cousin marriage and uncle-niece marriage. In South India, the father's brother is equivalent to the mother's sister's husband — both are called by the same kinship term — and their children, who would be parallel cousins from a Northern perspective, are here actually treated as potential spouses. The father's sister's group is equated with the mother's brother's group. This equation means that certain kinship terms extend love downward (toward younger kin) and respect upward (toward older kin), cutting across generational lines — father is treated like an elder brother, mother like an elder sister, and younger brother like a son.</p>

<p>Exogamy is not as exhaustive as in North India. The husband-wife relationship is not subordinated to the father-son relationship — conjugal bonds are stronger and more equal. The hostility that typically characterises the relationship between in-laws, driven by suspicion about divided loyalties, is weaker in South India precisely because the bride is likely to be a known relative rather than a stranger from a distant village.</p>

<h3>Central Indian Kinship System</h3>

<p>The Central Indian zone covers Gujarat, Maharashtra, and Madhya Pradesh and represents a mixture of elements from the North and South Indian systems. Among Rajputs, marriage is governed largely by the status of the girl's family — there is no strict caste bar, and a man can marry a girl of his choice provided the family is of appropriate standing. The Marathas have thirty-two divisions subdivided into primary, secondary, and tertiary levels — marriage is governed accordingly, with strict rules about which levels can intermarry. Among the Kumbis of Gujarat, a man cannot marry within one generation on his father's side or within three generations on his mother's side. In Rajasthan, Akshaya Tritiya is the occasion for mass marriages that cut across age groups and represent a loosening of the usual normative framework.</p>

<h3>Eastern Indian Kinship System</h3>

<p>The Eastern zone includes tribal communities such as the Mundas of Odisha, the Manipuris of Manipur, the Nagas, Kukis, and Khasis of the Northeast. The Mundas have six exogamous clans associated with totemic symbols — bamboo, lizards, teak, crocodiles, and others. Each clan contains many lineage groups. Sons receive the name of the patrilineal grandfather and daughters the name of the patrilineal grandmother — a system that maintains patrilineal continuity while extending symbolic continuity through naming. Divorce is relatively common among the Mundas, unlike many other Indian groups.</p>

<p>The Khasis of Meghalaya are matrilineal — the youngest daughter inherits property from her mother, and the status of men in the Khasi system is analogous to the status of women in North Indian systems: they marry out, move to their wife's household, and their children belong to the mother's clan rather than theirs. This reversal illustrates that the particular arrangements of any kinship zone are cultural constructs, not natural necessities.</p>

<p>These four kinship zones collectively speak to India's fundamental pluralism. The unity of Indian society does not lie in a uniform kinship system but in the coexistence of radically different residential systems, property relations, gender statuses, and marriage rules. As the Khasi example shows, entitlements based on gender are not uniform across India — they vary structurally by kinship zone.</p>

<h2>Family and Marriage in India</h2>

<p>The study of the Indian family has been dominated by the debate between the joint family and the nuclear family — a debate which became especially charged after independence, when modernisation theorists predicted the inevitable decline of the joint family under the pressures of industrialisation, urbanisation, and Westernisation.</p>

<p>David Mandelbaum considers the joint family one of the three distinguishing characteristics of Indian society (alongside the caste system and the village). Henry Maine and O. Mailey studied the traditional Indian joint family and termed it patriarchal. Maine, as legal advisor to the colonial government, compared the Indian joint family with Roman and Greek joint family systems and concluded it rested on two principles: common property holdings and the absolute authority of the Karta (male head). It is a corporate unit where everyone contributes differently but takes according to need — sustained by moral institutions and rituals for common deceased ancestors.</p>

<p>GS Ghurye argued that the joint family is a product of Indian culture that glorified classical values — it has universal presence across caste, religion, and region in India. PN Prabhu added that the individual's association with the joint family is based on moralism — when moralism converts to individualism (as happens under modernity), the joint family converts to the nuclear family. Irawati Karve described the joint family as encompassing three to four generations of people organically related to each other through common kitchen, common residence, common rituals, and common obligations to the Karta. For her, the joint family is a product of culture, and therefore economic transformations alone cannot dismantle it.</p>

<p>Yogendra Singh's <em>Modernisation of Indian Tradition</em> identified several structural changes in urban India that suggest the joint family is weakening: inter-caste marriages, love marriages, nuclear family formation, greater sexual openness, occupational mobility enabled by industry, women's empowerment, and structural breakdown of joint household arrangements. Yet MN Srinivas and SC Dube found that higher castes tend to maintain the joint family while lower castes tend toward nuclear arrangements — and that joint family formation is driven by economic logic (pooling resources) rather than purely cultural logic. This is the opposite of the Westernisation-as-dissolution thesis.</p>

<p>Alan Rose's study in Bangalore found that 70% of families maintained either structural jointness or functional jointness or both — a finding that directly contradicted predictions of nuclear family dominance. MS Gore's study of Agarwals in Delhi found that the mother-son relationship precedes the husband-wife relationship — the family provides strong support for its members in selection of occupation, financial assistance, and selection of mates. TN Madan emphasised that even where residential separation occurs, the "Money Order Economy" — remittances from migrant workers to families back home — maintains functional jointness. Family jointness has always been enduring in India. Shah and Kolenda's combined evidence demolished the myth of joint family disintegration.</p>

<h3>Marriage in Contemporary India</h3>

<p>Marriage in India is simultaneously undergoing change and displaying remarkable continuities. Marriage remains an important social institution that all are expected to enter into. Choices available to individuals, especially women, are very few — marriage and motherhood are still taken to be the ultimate goals of a woman's life. A woman's identity is largely seen as dependent on her marital status even in urban upper-middle-class contexts. Arranged marriages remain the preferred form, though semi-arranged marriages (where individuals choose partners but only with parental consent) are increasingly common. Inter-caste and inter-religious marriages are being conditionally tolerated in upper-middle-class urban settings — but Hindu-Muslim and Hindu-Christian marriages remain largely taboo. Wedding ceremonies continue to be performed in traditional ways regardless of the class background of the participants.</p>

<h2>Household Dimensions of the Family</h2>

<p>AM Shah's landmark book <em>The Household Dimension of the Family in India</em> shifted the analytical unit from "family" (a cultural and normative concept) to "household" (an empirically observable unit of coresidence and economic cooperation). Shah's fundamental question was whether joint households are disintegrating. His finding was that the proportion of joint households is actually higher today compared to the past — for multiple material reasons: rising population makes separate housing costly; migration for employment is temporary, not permanent; bigger households split into smaller residential units but maintain strong emotional ties without actually dissolving family bonds. What is splitting is not the joint family but joint household co-residence — and these two must be analytically distinguished.</p>

<p>Shah proposed studying the household along four dimensions: commensal (eating together), co-resident (living together), coparcenary (sharing property), and co-ritual (sharing religious practices). A household may be commensal but not co-resident, or co-ritual but not coparcenary — the dimensions can come apart in ways that complicate simple joint-nuclear dichotomies. He identified two types of households: simple (nuclear core) and compound (two or more parents and their families sharing a household).</p>

<p>Pauline Kolenda confirmed that even after modernity, joint households and joint families still exist. The number of nuclear families is higher than joint families, but the average household size is increasing because death rates have fallen and longevity has increased — more generations are alive simultaneously. Households have lifecycles: fission (joint household splits after children marry), followed by fusion (remarriage or return of children), followed by fission again. The stem family — where parents reside with one married child while other children set up separate households — is a very common form. Rural households are larger than urban ones. Regional differences persist: North India has larger joint families than South India. Shah and Kolenda together broke the myth of joint family disintegration in India.</p>

<p>A feminist perspective on household transformation observes that whether a family is joint or nuclear, the transformation is not significantly affecting the status of women — sexuality, division of labour, and reproduction continue to be governed by patriarchy in both forms.</p>

<p>Contemporary trends are moving the analytical focus from family study to household study. With global migration, married women in countries like the Philippines and India are living in households with friends or alone while their families remain in the home country — the household becomes the primary unit of daily life while the family remains a normative reference point. In urban households, friendships often carry more practical importance than kinship ties. Individual liberty, sexual freedom, and limited liability toward other members characterise these new household forms — particularly suited to a fragile or mobile population. In Scandinavian countries, census data gives more importance to household than to family. This trend of household study gradually replacing family study parallels the trend of friendship study replacing kinship study as the primary mode of voluntary social bonding.</p>

<h2>Patriarchy, Entitlements, and Sexual Division of Labour</h2>

<p>An entitlement is a form of individual right — driven by culture, rules of law, and social norms. In modernist theory, various forms of entitlements have been extended to every section of society — gender is no longer supposed to be a criterion for differential entitlement. Talcott Parsons argued that industrialisation, urbanisation, migration, and occupational mobility have empowered women and reduced the gender gap. Modernist theory in the Indian context predicts: the conjugal relationship taking precedence over obligations toward kinship; irrespective of gender, every child inheriting property from parents; selection of mates becoming the individual's responsibility; childbirth linked to mutual agreement between spouses; and modernity breaking down traditional hierarchical forms of marriage.</p>

<p>But the reality of women's entitlements in India contradicts this modernist optimism. Hinduism has historically emphasised sexual purity — requiring child marriage, treating premarital sex as immoral, considering male children necessary for a woman's fulfilment, treating divorce as evil, and viewing widowhood as a catastrophe. Culture defines sexuality, reproduction, and the division of labour in ways that laws alone cannot easily override.</p>

<p>Indira Jai Singh observed that all Indian laws of entitlement are based on patriarchy rather than gender equality — the Hindu Marriage Act allows divorce on grounds of adultery, but the adultery must be proved in court. Rape survivors must recreate the experience of violation again and again in the legal process in order to get justice. Inheritance rights over parental property were extended to women only recently, and even now the social pressure not to claim against brothers is enormous.</p>

<p>Tulsi Patel's fieldwork shows that women consider it sinful to prohibit their husbands from sexual access, leading to unwanted pregnancies. Women lose their lives during childbirth; even in poor health, they accept patriarchal convention — forgetting their entitlements. Women's wages are less than half of men's wages despite women doing twice the amount of work in factories. For these women, family is "a paradise in a hopeless world" — where marriage, childbirth, and motherhood are made to seem like they make a woman's life complete. Feminist movements, as Tulsi Patel notes, are not rebellions against patriarchy — they are asking for equality, for the recognition of entitlements that already exist in law but not in social practice.</p>

<p>The sexual division of labour (SDOL) in India is not simply a legacy of tradition — it is continuously reproduced through the kinship system. The kinship zone a person inhabits determines the entitlements they possess. A Khasi woman has matrilineal property rights; a North Indian woman's inheritance rights were legally equalised with men's only in 2005 (Hindu Succession Amendment). The four kinship zones thus create structurally different entitlement landscapes for women — further complicating any unified account of gender in India.</p>
`,
