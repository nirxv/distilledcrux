    ...
    <div style={{ maxWidth: 900, margin: '0 auto', padding: '2.5rem 1.5rem 5rem' }}>
      ...
      <div style={{ marginBottom: '3rem' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
          ...
          <span style={{ color: 'var(--text2)', fontSize: '0.88rem', fontWeight: 500, fontFamily: 'var(--font-ui)' }}>Administrative Theory</span>
        </div>
      ...
      <div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
          ...
          <span style={{ color: 'var(--text2)', fontSize: '0.88rem', fontWeight: 500, fontFamily: 'var(--font-ui)' }}>Indian Administration</span>
        </div>
