...
import { paper1Notes, paper2Notes } from '@/lib/notes/polsci';

export const metadata: Metadata = {
  title: 'Political Science & IR Optional Notes — UPSC Mains Paper I & II | Distilled Crux',
  description: 'Comprehensive free notes for UPSC Political Science & International Relations (PSIR) Optional covering Paper I — Political Theory & Indian Government, and Paper II — Comparative Politics & International Relations.',
...
const SECTIONS_P1 = [
  ...
  { label: 'Indian Government and Politics', value: 'Indian Government and Politics' },
];

const SECTIONS_P2 = [
  { label: 'Comparative Political Analysis and International Politics', value: 'Comparative Political Analysis and International Politics' },
  { label: 'India and the World', value: 'India and the World' },
];
  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', padding: '2.5rem 1.5rem 5rem' }}>
      ...
      <div style={{ color: 'var(--text3)', fontSize: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '0.5rem', display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
        ...
        <span>·</span>
        <span>Political Science & IR</span>
      </div>
      ...
      <div style={{ marginBottom: '3rem' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
          <span style={{
            ...
            color: COLOR, background: 'rgba(124,58,237,0.1)',
            border: '1px solid rgba(124,58,237,0.25)', padding: '3px 10px', borderRadius: 4,
          }}>Paper I</span>
          <span style={{ color: 'var(--text2)', fontSize: '0.88rem', fontFamily: 'var(--font-ui)' }}>Political Theory & Indian Government</span>
        </div>
      ...
      <div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
          <span style={{
            ...
            border: '1px solid rgba(6,182,212,0.22)', padding: '3px 10px', borderRadius: 4,
          }}>Paper II</span>
