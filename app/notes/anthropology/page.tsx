...
const COLOR = '#2dd4bf';
const COLOR_BG = 'rgba(45,212,191,0.09)';
const COLOR_BORDER = 'rgba(45,212,191,0.25)';

const SECTIONS_P1 = [
  { label: 'Foundations of Anthropology', value: 'Foundations of Anthropology' },
  { label: 'Physical Anthropology', value: 'Physical Anthropology' },
  { label: 'Archaeological Anthropology', value: 'Archaeological Anthropology' },
  { label: 'Socio-Cultural Anthropology', value: 'Socio-Cultural Anthropology' },
  { label: 'Methods', value: 'Methods' },
];

const SECTIONS_P2 = [
  { label: 'Indian Prehistory & Archaeology', value: 'Indian Prehistory & Archaeology' },
  { label: 'Indian Society & Social Structure', value: 'Indian Society & Social Structure' },
  { label: 'Tribal India', value: 'Tribal India' },
];

export default function AnthropologyNotesPage() {
  return (
          ...
          return (
            <div key={value} style={{ marginBottom: '2rem' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
                {notes.map((note) => (
                  <Link key={note.slug} href={`/notes/anthropology/${note.slug}`} style={{ textDecoration: 'none' }}>
                    <div style={{
